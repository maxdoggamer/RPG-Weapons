...
public class DaggerEntity extends AbstractArrow implements ItemSupplier {
	public DaggerEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(MinecraftRpgweaponsModEntities.DAGGER.get(), world);
	}
	...
	public static DaggerEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		DaggerEntity entityarrow = new DaggerEntity(MinecraftRpgweaponsModEntities.DAGGER.get(), entity, world);
	...
	public static DaggerEntity shoot(LivingEntity entity, LivingEntity target) {
		DaggerEntity entityarrow = new DaggerEntity(MinecraftRpgweaponsModEntities.DAGGER.get(), entity, entity.level());
