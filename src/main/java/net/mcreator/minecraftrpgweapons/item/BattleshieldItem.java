...
public class BattleshieldItem extends Item {
	public BattleshieldItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		BattleshieldRightClickedOnBlockProcedure.execute(entity, ar.getObject());
		return ar;
	}
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		BattleshieldRightClickedOnBlockProcedure.execute(context.getPlayer(), context.getItemInHand());
